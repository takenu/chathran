...
void setup()
{
    ...
    terrainHeightTexture = new draw::FloatTexture2D(img::io::readImage(DATA_DIRECTORY + "terrain/512hills.png"), draw::tf::filter);
    ...
    treeTrunkDiffuseTexture = new draw::RGBTexture2D(img::io::readImage(DATA_DIRECTORY + "img/veg/tree0_trunk.png"));
    treeTrunkNormalTexture = new draw::RGBTexture2D(img::io::readImage(DATA_DIRECTORY + "img/veg/tree0_trunk_normal.png"));
    ...
    treeLeavesDiffuseTexture = new draw::RGBATexture2D(img::io::readImage(DATA_DIRECTORY + "img/veg/tree0_leaves.png"));
    ...
    treeSpriteTexture = new draw::RGBATexture2D(img::io::readImage(DATA_DIRECTORY + "img/veg/tree0_sprite.png"));
    ...
    skyGradientTexture = new draw::RGBATexture2D(img::io::readImage(DATA_DIRECTORY + "img/sky/sky.png"));
